...
Le projet fil rouge a pour objectif de montrer nos compétences en front-end et back-end à l'issue de la formation. 

"Nom de l'application web & web mobile" est une application web permettant de créer une liste d'achat aussi appelée liste d'envies à partir de produits mis en vente sur tous types de sites de e-commerce. 
...
Une maquette réalisée avec Figma.

#### Front-end

Réaliser la partie front-end du projet à l'aide des langages de développement figurant dans le référentiel de formation.
...
Réaliser la partie back-end du pojet à l'aide des langages de développement figurant dans le référentiel de formation.
...
Pense-bête : à la fin, créer le fichier ReadMe du projet.